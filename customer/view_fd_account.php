...
$sql = "SELECT * FROM accounts 
        ...
        where accounts.f_id!='0' and  accounts.c_id='$get_id'";
$stmt = $con->query($sql);
                    ...
                    <div class="card card-default mt-2">
                        <div class="card-header">
                            ...
                            <div class="pull-right" style="text-align: right;">
                                <a href="add_fd_account.php" class="btn btn-info"><i class="fas fa-plus"></i> Add FD Account</a>
                            ...
                            <div class="col-lg-12 col-sm-12 col-md-12 col-xl-12">
                                ...
                                <table id="example1" class="table table-bordered table-striped table-sm">
                                    ...
                                    $q = "SELECT * FROM accounts 
                                          ...
                                          where customers_master.c_id='$get_id' and accounts.account_type='Fixed Deposite Account' and accounts.f_id!='0'";
                                    $stmt = $con->query($q);
